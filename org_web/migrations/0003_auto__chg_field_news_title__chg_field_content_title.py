...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('org_web_news', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Content.title'
        db.alter_column('org_web_content', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'News.title'
        db.alter_column('org_web_news', 'title', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Content.title'
        db.alter_column('org_web_content', 'title', self.gf('django.db.models.fields.CharField')(max_length=30))
