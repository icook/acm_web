...
ALLOWED_HOSTS = ['people.eecs.ku.edu',]
...
SECRET_KEY = 'tm=9q5m_3krwu8+ku@g&amp;neo+qp=95ep1pu+0n12qe8(12_yrhj'
...
ROOT_URLCONF = 'acm_site.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'acm_site.wsgi.application'
...
# the acm_site admins on every HTTP 500 error when DEBUG=False.
